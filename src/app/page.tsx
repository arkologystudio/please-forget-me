  ...
  return (
    <div className="min-h-screen bg-slate-100">
          ...
          <div className="space-y-4">
            <div>
              <div className="relative">
                <p className={`text-2xl md:text-4xl leading-tight text-slate-700 max-w-3xl font-bold flex items-center z-99`}>
                ...
                <div className={`transition-all duration-500 ${showMore ? 'opacity-100 max-h-96' : 'opacity-0 max-h-0'} overflow-hidden `}>
                  <p className="text-lg text-slate-600 max-w-3xl mt-2">
                    Today, it is likley your personal data is being used to train Large Language Models and other AI systems. Under data protection regulations such as Europe's GDPR you may have the legal right to request removal of your personal data from these systems.
                  </p>
                  <p className="text-lg text-slate-600 max-w-3xl mt-2">
              ...
              <p className="text-2xl md:text-4xl leading-tight text-slate-700 max-w-3xl mt-8">
                Please Forget Me helps exercise your <i>Right To Be Forgotten</i> from AI companies, including OpenAI, Meta and Google.
              </p>
            </div>
      ...
      <section className="bg-slate-900 py-16">
        <div id="form-section" className="container mx-auto px-8 py-16 max-w-2xl bg-slate-100 rounded-lg">
          <RTBFForm />
        </div>
      </section>
    </div>
